NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      "section": "api",
      "id": "lx.form.lxForm",
      "shortName": "lx.form.lxForm",
      "type": "object",
      "moduleName": "lx.form",
      "shortDescription": "Form service which allow caching, reset the object and populates validation errors.",
      "keywords": "add allow angularjs api cache caching changes checks controller current currentkey errors false form formcontroller hasloadedmodelfromcache isunchanged key load loaded lx lxcache lxform master method model modelname object populates populateservervalidation property reset resetcache resetform resets resetted server service setmodel sets specifies true unchanged validation"
    },
    {
      "section": "api",
      "id": "lx.integer.directive:lxInteger",
      "shortName": "lxInteger",
      "type": "directive",
    ...
    {
      "section": "api",
      "id": "lx.navigation.$lxNavigation",
      "shortName": "lx.navigation.$lxNavigation",
      "type": "object",
    ...
    {
      "section": "api",
      "id": "lx.navigation.directive:lxComNav",
      "shortName": "lxComNav",
      "type": "directive",
      "moduleName": "lx.navigation",
    ...
    {
      "section": "api",
      "id": "lx.navigation.directive:lxComNavTree",
      "shortName": "lxComNavTree",
      "type": "directive",
      "moduleName": "lx.navigation",
    ...
    {
      "section": "api",
      "id": "lx.socket.$lxSocket",
      "shortName": "lx.socket.$lxSocket",
      "type": "service",
      "moduleName": "lx.socket",
    ...
    {
      "section": "api",
      "id": "lx.socket.$lxSocket#set",
      "shortName": "lx.socket.$lxSocket#set",
      "type": "service",
      "moduleName": "lx.socket",
